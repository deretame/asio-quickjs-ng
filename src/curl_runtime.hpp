...
class Client : public std::enable_shared_from_this<Client> {
 public:
  ...
  explicit operator bool() const { return static_cast<bool>(multi_); }
 ...
 private:
  ...
  friend int curl_socket_callback(CURL* /*easy*/, curl_socket_t s, int what,
                                  void* userp, void* socketp);
  friend int curl_timer_callback(CURLM* /*multi*/, long timeout_ms,
                                 void* userp);
